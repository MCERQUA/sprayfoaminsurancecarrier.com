...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `${loc.blurb} GL, off-ratio coverage, CPL, workers' comp, and commercial auto for spray foam contractors in ${loc.name}. 15-minute quotes.`,
            ...
            <div className="grid lg:grid-cols-12 gap-10 items-center">
              ...
              <FadeIn direction="left" className="lg:col-span-5">
                <div className="rounded-t-[10rem] rounded-b-3xl overflow-hidden border-4 border-white shadow-warm-lg">
                  <img src="/images/coverage.jpg" alt={`Spray foam contractor coverage in ${loc.name}`} className="w-full h-[300px] md:h-[360px] object-cover" loading="lazy" />
                </div>
              </FadeIn>
            </div>
          </div>
        ...
        <section className="bg-cream py-16 md:py-20">
          <div className="container-tight">
            <FadeIn className="max-w-2xl mb-10">
              ...
              <p className="mt-4 lead">From a single-crew operation to a multi-location company, we coordinate every line a {loc.name} spray foam contractor needs.</p>
            </FadeIn>
